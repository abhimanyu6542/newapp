            ...
            <div className='bottom-0 flex flex-col justify-between w-full p-5 bg-white md:w-72 lg:w-60 rounded-xl group hover:shadow-2xl '>
                ...
                <div>
                    <div className='pb-5 my-5 border-b-2 border-slate-300'>
                        ...
                        <h1 className='mb-3 text-2xl font-bold text-black'>Store</h1>
                        <h3 className='mb-2 text-4xl font-bold text-black'>$43.00/<span className='text-sm font-normal'>mo</span></h3>
                ...
                <div className='flex justify-center w-full'>
                    <button className='w-full py-2 mt-5 font-medium border-0 rounded-lg text-md text-blue2 bg-blue1 group-hover:text-white group-hover:bg-blue2' >Get started</button>
                </div>
            </div>
        </>
    )
